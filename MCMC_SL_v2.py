...
#2D samples
s_plot_max = 1000
fig_data, axs = plt.subplots(2,2, figsize=(20,12))
fig_data.suptitle('All Sample Data', fontsize=22)
axs[0,0].plot(samples[:s_plot_max,0])
...
axs[1,0].hist(samples[:s_plot_max,0],100)
...
axs[0,1].plot(samples[:s_plot_max,1])
...
axs[1,1].hist(samples[:s_plot_max,1],100)
